        ...
        <form action="{{ route('post_reg_factura') }}" method="POST" enctype="multipart/form-data">
            ...
            <section class="seccion_uno">
                <button class="crear_factura" type="reset">
                    <svg class="svg" xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-bookmark-plus"
                        viewBox="0 0 16 16">
                        <path
                ...
                <div class="imprimir">
                    <button>
                        <svg class="svg" xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-printer"
                            viewBox="0 0 16 16">
                    ...
                    <button>
                        <svg class="svg" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
